...
func (handlerGroup *HandlerGroup) GetDeviceCommands(context echo.Context) error {
	response, err := handlerGroup.Accessors.GetDeviceCommands()
	if err != nil {
